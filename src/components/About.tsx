  ...
  return (
    <section id="about" className="relative py-24 px-4">
      <div className="mx-auto max-w-7xl">
        ...
        {/* Bio */}
        <motion.p
          className="text-lg text-slate-400 text-center max-w-3xl mx-auto mb-16 leading-relaxed"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={fadeInUp}
          ...
          >
            ...
            <div className="space-y-3">
              {achievements.map((ach, i) => (
                <motion.div
                  key={i}
                  className="glass rounded-xl p-4 hover:bg-white/[0.06] transition-all duration-300"
                  variants={fadeInUp}
                >
